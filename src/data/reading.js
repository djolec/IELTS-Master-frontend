export const passages = [
  {
    ...
    subtitle: "The man who invented synthetic dyes",
...
`,
    questions: [
      {
        ...
        questions: [
          {
            id: 1,
            text: "Michael Faraday was the first person to recognise Perkin's ability as a student of chemistry.",
          },
          {
            id: 2,
            text: "Michael Faraday suggested Perkin should enrol in the Royal College of Chemistry.",
          },
          {
            id: 3,
      ...
      },
      {
        ...
        questions: [
          ...
          {
            id: 10,
            text: "What was the name finally used to refer to the first colour Perkin invented?",
          },
          {
            id: 11,
...

  {
    ...
    subtitle: "The Search for Extra-terrestrial Intelligence",
    ...
    questions: [
      {
        ...
        instruction:
          "Reading Passage 2 has five paragraphs, A–E. Choose the correct heading for paragraphs B–E from the list of headings below.",
        headings: [
        ...
        questions: [
          ...
          },
          {
            id: 17,
            text: "Paragraph E",
            correctAnswer: "ii", // Appropriate responses to signals from other civilisations
          },
        ],
      },
      {
        ...
        steps: [
          {
            ...
            content: [
              {
                text: "71 species of living turtles and tortoises were examined and a total of ...... were taken from the bones of their forelimbs.",
                questionId: 34,
                correctAnswer: "three measurements",
              },
            ],
          },
          {
            ...
            content: [
              {
                text: "The data was recorded on a ...... (necessary for comparing the information).",
                questionId: 35,
                correctAnswer: "triangular graph",
              },
              {
                text: "Outcome: Land tortoises were represented by a dense ...... of points towards the top.",
                questionId: 36,
                correctAnswer: "cluster",
              },
              {
                text: "Sea turtles were grouped together in the bottom part.",
              },
            ],
          },
          {
            ...
            content: [
              {
                text: "The same data was collected from some living ...... species and added to the other results.",
                questionId: 37,
                correctAnswer: "amphibious",
              },
              {
                text: "Outcome: The points for these species turned out to be positioned about ...... up the triangle between the land tortoises and the sea turtles.",
                questionId: 38,
          ...
          },
          {
            ...
            content: [
              {
                text: "Bones of P. quenstedti and P. talampayensis were examined in a similar way and the results added.",
              },
              {
                text: "Outcome: The position of the points indicated that both these ancient creatures were ......",
                questionId: 39,
